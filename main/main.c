...
void init_wm8960(void)
{
    ...
    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R10_LEFT_DAC_VOLUME_REG, WM8960_R10_DACVU | WM8960_R10_LDACVOL(255)));

    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R11_RIGHT_DAC_VOLUME_REG, WM8960_R11_DACVU | WM8960_R11_RDACVOL(255)));

    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R4_CLOCKING_1_REG, 0));

    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R5_ADC_AND_DAC_CTRL1_REG, 0));

    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R7_AUDIO_INTERFACE_REG, WM8960_R7_FORMAT(0b10)));
    ...
    ESP_ERROR_CHECK(wm8960_register_write_byte(WM8960_R2_LOUT1_VOLUME_REG, WM8960_R2_OUT1VU | WM8960_R2_LOUT1VOL(0b1111001)));
